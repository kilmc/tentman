...
- [x] First repository open does not immediately repeat broad config/bootstrap work for freshness.
- [x] Compatibility fallbacks remain behind the workflow capability boundary and log route, source, and reason whenever used.
- [x] Tests cover normal bootstrap, config-state, fallback logging, and unchanged-freshness separation.
