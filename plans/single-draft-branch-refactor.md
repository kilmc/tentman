...
export const load: PageServerLoad = async ({ locals, cookies }) => {
	...
	const commits = await getCommitsSince(locals.octokit, owner, name, 'main', draftBranchName);
...
<div class="container mx-auto p-6">
	<h1 class="mb-6 text-3xl font-bold">Publish Changes</h1>
		...
		<div class="space-y-4">
			{#each data.configsWithChanges as { config, changes }}
				<div class="rounded-lg border border-gray-200 bg-white p-4">
					<h3 class="mb-2 font-medium">{config.config.label}</h3>
	...
	<!-- Commits -->
	<div class="mb-8">
		<h2 class="mb-4 text-xl font-semibold">Commits</h2>
		<div class="space-y-2">
